...
<script type="text/javascript" src="js/pages/back/admin/resource/resource_apply_list.js"></script>
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<table class="table table-condensed">
					...
					<tbody>
						<tr>
							<td class="text-center"><span id="resid-7369" style="cursor:pointer;">办公用品领取</span></td>
		...
		<jsp:include page="/pages/plugins/back/admin/resource/resource_details_modal.jsp"/>
