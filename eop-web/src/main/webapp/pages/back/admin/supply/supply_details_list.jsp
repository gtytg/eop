...
<%!
	public static final String SUPPLY_EDIT_URL = "pages/back/admin/supply/supply_goods_edit.action" ;
	public static final String SUPPLY_GOODS_ADD_URL = "pages/back/admin/supply/goods_add_pre.action" ;
%>
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<table class="table table-condensed">
					<thead>
						<tr>
							...
							<c:if test="${fn:contains(actionList,'supply:edit')}">
				...
				<a class="btn btn-success" id="addBtn"
				   href="<%=SUPPLY_GOODS_ADD_URL%>?spid=${spid}">
					<span class="glyphicon glyphicon-plus-sign"></span>&nbsp;追加待采购商品</a>
