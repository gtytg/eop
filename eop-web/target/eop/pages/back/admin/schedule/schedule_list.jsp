			...
			<div class="panel-body">
				...
				<table class="table table-condensed">
					...
					<c:forEach items="${myPlanList}" var="myPlan">
						<tr>
							<td class="text-center"><span id="misid-${myPlan.pid}" style="cursor:pointer;">${myPlan.title}</span></td>
							<td class="text-center">${myPlan.item}</td>
							<td class="text-center">${myPlan.eid}</td>
							<td class="text-center">${myPlan.starttime}</td>
							<td class="text-center">${myPlan.endtime}</td>
							<td class="text-center">${myPlan.amount}</td>
						</tr>
					</c:forEach>
					</tbody>
				</table>
